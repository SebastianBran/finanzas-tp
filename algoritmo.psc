...
Algoritmo Frances
	...
	Definir frecuencia_del_cupon Como Caracter
	Definir dias_por_anio Como Entero
	Definir tipo_tasa_interes Como Caracter
	Definir capitalizacion Como Caracter
	Definir tasa_interes Como Real
	Definir tasa_anual_descuento Como Real
	Definir impuesto_renta Como Real
	Definir fecha_de_emision Como Caracter
